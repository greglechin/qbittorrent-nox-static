...
namespace BitTorrent
{
    ...
    public:
        ...
        virtual int dhtUploadRateLimit() const = 0;
        virtual void setInactivityTimeout(int value) = 0;
        virtual int inactivityTimeout() const = 0;
        virtual void setMaxAllowedInRequestQueue(int value) = 0;
        virtual int maxAllowedInRequestQueue() const = 0;
        virtual void setMaxFailCount(int value) = 0;
        virtual int maxFailCount() const = 0;
        virtual void setHttpRecvBufferSize(int value) = 0;
        virtual int httpRecvBufferSize() const = 0;
        virtual void setMaxRejects(int value) = 0;
        virtual int maxRejects() const = 0;
        virtual void setNoAtimeStorage(bool value) = 0;
        virtual bool noAtimeStorage() const = 0;
        virtual void setPeerTimeout(int value) = 0;
        virtual int peerTimeout() const = 0;
        virtual void setReadCacheLineSize(int value) = 0;
        virtual int readCacheLineSize() const = 0;
        virtual void setRequestTimeout(int value) = 0;
        virtual int requestTimeout() const = 0;
        virtual void setUseReadCache(bool value) = 0;
        virtual bool useReadCache() const = 0;
        virtual void setWriteCacheLineSize(int value) = 0;
        virtual int writeCacheLineSize() const = 0;
