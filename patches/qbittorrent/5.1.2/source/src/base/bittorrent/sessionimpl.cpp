...
SessionImpl::SessionImpl(QObject *parent)
    ...
    , m_maxAllowedInRequestQueue(BITTORRENT_SESSION_KEY(u"MaxAllowedInRequestQueue"_s), 2000)
    , m_maxFailCount(BITTORRENT_SESSION_KEY(u"MaxFailCount"_s), 1)
    , m_httpRecvBufferSize(BITTORRENT_SESSION_KEY(u"HttpRecvBufferSize"_s), 6291456)
    , m_maxRejects(BITTORRENT_SESSION_KEY(u"MaxRejects"_s), 10)
    , m_noAtimeStorage(BITTORRENT_SESSION_KEY(u"NoAtimeStorage"_s), true)
    , m_peerTimeout(BITTORRENT_SESSION_KEY(u"PeerTimeout"_s), 20)
    , m_readCacheLineSize(BITTORRENT_SESSION_KEY(u"ReadCacheLineSize"_s), 20)
    , m_requestTimeout(BITTORRENT_SESSION_KEY(u"RequestTimeout"_s), 10)
    , m_useReadCache(BITTORRENT_SESSION_KEY(u"UseReadCache"_s), true)
    , m_writeCacheLineSize(BITTORRENT_SESSION_KEY(u"WriteCacheLineSize"_s), 256)
...
{
    return m_closeRedundantConnections;
}

void SessionImpl::setCloseRedundantConnections(const bool value)
{
    if (value == m_closeRedundantConnections) return;
...
{
    return m_dhtUploadRateLimit;
}

void SessionImpl::setDhtUploadRateLimit(const int value)
{
    if (value == m_dhtUploadRateLimit) return;
...
void SessionImpl::setMaxAllowedInRequestQueue(const int value)
{
    if (value == m_maxAllowedInRequestQueue) return;
...
{
    return m_maxFailCount;
}

void SessionImpl::setMaxFailCount(const int value)
{
    if (value == m_maxFailCount) return;
...
{
    return m_httpRecvBufferSize;
}

void SessionImpl::setHttpRecvBufferSize(const int value)
{
    if (value == m_httpRecvBufferSize) return;
...
void SessionImpl::setMaxRejects(const int value)
{
    if (value == m_maxRejects) return;
...
{
    return m_noAtimeStorage;
}

void SessionImpl::setNoAtimeStorage(const bool value)
{
    if (value == m_noAtimeStorage) return;
...
void SessionImpl::setPeerTimeout(const int value)
{
    if (value == m_peerTimeout) return;
...
{
    return m_readCacheLineSize;
}

void SessionImpl::setReadCacheLineSize(const int value)
{
    if (value == m_readCacheLineSize) return;
...
{
    return m_useReadCache;
}

void SessionImpl::setUseReadCache(const bool value)
{
    if (value == m_useReadCache) return;
...
{
    return m_writeCacheLineSize;
}

void SessionImpl::setWriteCacheLineSize(const int value)
{
    if (value == m_writeCacheLineSize) return;
