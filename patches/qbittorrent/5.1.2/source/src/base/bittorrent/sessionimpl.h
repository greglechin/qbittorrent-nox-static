...
namespace BitTorrent
{
    ...
    public:
        ...
        int dhtUploadRateLimit() const override;
        void setInactivityTimeout(int value) override;
        int inactivityTimeout() const override;
        void setMaxAllowedInRequestQueue(int value) override;
        int maxAllowedInRequestQueue() const override;
        void setMaxFailCount(int value) override;
        int maxFailCount() const override;
        void setHttpRecvBufferSize(int value) override;
        int httpRecvBufferSize() const override;
        void setMaxRejects(int value) override;
        int maxRejects() const override;
        void setNoAtimeStorage(bool value) override;
        bool noAtimeStorage() const override;
        void setPeerTimeout(int value) override;
        int peerTimeout() const override;
        void setReadCacheLineSize(int value) override;
        int readCacheLineSize() const override;
        void setRequestTimeout(int value) override;
        int requestTimeout() const override;
        void setUseReadCache(bool value) override;
        bool useReadCache() const override;
        void setWriteCacheLineSize(int value) override;
        int writeCacheLineSize() const override;
    ...
    private:
        ...
        CachedSettingValue<int> m_maxAllowedInRequestQueue;
        CachedSettingValue<int> m_maxFailCount;
        CachedSettingValue<int> m_httpRecvBufferSize;
        CachedSettingValue<int> m_maxRejects;
        CachedSettingValue<bool> m_noAtimeStorage;
        CachedSettingValue<int> m_peerTimeout;
        CachedSettingValue<int> m_readCacheLineSize;
        CachedSettingValue<int> m_requestTimeout;
        CachedSettingValue<bool> m_useReadCache;
        CachedSettingValue<int> m_writeCacheLineSize;
